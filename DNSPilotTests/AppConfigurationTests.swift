...
struct AppConfigurationTests {
    ...
    @Test func profileConfigurationRoundTripPreservesHosts() throws {
    ...
    @Test func legacyProfileWithoutHostsMigratesToEmptyHosts() throws {
        let host = try DNSHostEntry(domain: "example.test", address: IPAddress("192.0.2.10"))
        let profile = try DNSProfile(
            id: profileID,
            name: "Primary",
        ...
        profiles[0].removeValue(forKey: "hosts")
